...
// Data makanan statis sebagai fallback
const staticFoodMenu = [
  {
    id: "burger",
    name: "Burger",
    description:
      "Burger juicy dengan daging premium, keju leleh, dan saus spesial.",
    price: "68.000",
    image:
  ...
  },
  {
    ...
    name: "Pizza",
    description:
      "Pizza renyah dengan topping tomat segar, keju mocarela, dan basil.",
    price: "75.000",
    image:
      "https://images.unsplash.com/photo-1548365328-1afbe1a0f62d?auto=format&fit=crop&w=800&q=80",
  },
  {
    id: "sushi",
    name: "Sushi",
    description:
      "Sushi segar dengan nasi pulen, ikan premium, dan saus mayo Jepang.",
    price: "82.000",
    image:
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Katalog makanan modern dengan Flexbox dan Expo Router.
      </Text>
        ...
        {Array.isArray(foods) && foods.length > 0 ? (
          foods.map((food) => (
            <FoodCard
              ...
              onPress={() =>
                router.push(
                  `/detail?name=${encodeURIComponent(food.name)}&id=${food.id}`,
                )
              }
            />
          ))
